...
module.exports = {
    ...
    "language.python.textMateGrammar": path.join(process.env.HOME, ".oni/python.json"),
    // "language.python.languageServer.command": "~/.oni/run_with_venv.sh",
    "language.python.languageServer.command": path.join(process.env.HOME, ".oni/run_pyls_with_venv.sh"),
